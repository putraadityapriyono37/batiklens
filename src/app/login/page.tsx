...
// Komponen ikon mata untuk toggle password visibility (reusable)
...
export default function LoginPage() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // TODO: Kirim data ke API Anda untuk autentikasi
    };
                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-between items-center space-x-4 mb-6">
                            ...
                            >
                                <img src="/google-logo.svg" alt="Google" style={{width: '20px', height: '20px'}} className="mr-2"/> {/* Asumsi ada logo Google di public */}
                    ...
                    <p className="mt-6 text-center text-gray-600">
                        Belum punya akun? <a href="/register" className="text-orange-500 font-semibold hover:underline">Daftar di sini</a>
                    </p>
                </div>
            </div>
        </div>
